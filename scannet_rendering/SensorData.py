...
class SensorData:
    ...
    def export_depth_images(self, output_path, folder='', image_size=None, frame_skip=50):
...
#             imageio.imwrite(os.path.join(output_path, folder+ '_ '+str(f) + '.png'), depth)
            io.imsave(os.path.join(output_path, folder+ '_'+str(f) + '.png'), depth)
#             np.save(os.path.join(output_path, folder+ '_ '+str(f) ), depth)


    def export_color_images(self, output_path, folder='', image_size=None, frame_skip=50):
        if not os.path.exists(output_path):
            os.makedirs(output_path)
        ...
        for f in range(0, len(self.frames), frame_skip):
            ...
            imageio.imwrite(os.path.join(output_path, folder+ '_'+str(f) + '.jpg'), color)
