...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--model_type', type=str, default='I2D', help='chooses which model to use. [I2D | main]')
        ...
        parser.add_argument('--batch_size_val', type=int, default=1, help='input batch size')
