...
#         parser.add_argument('--path_A', type=str, default='/mnt/neuro/depth/NYUv2/InteriorNet/trainB/depth', help='path_A')
        parser.add_argument('--path_A', type=str, default='/root/datasets/un_depth/Scannet_ssim/trainB/full_size/hr', help='path_A')
...
#         parser.add_argument('--A_add_paths', type=str, default='/mnt/neuro/depth/NYUv2/InteriorNet/trainB/img', help='path_A_test')
        parser.add_argument('--A_add_paths', type=str, default='/root/datasets/un_depth/Scannet_ssim/trainB/full_size/img', help='path_A_test')
